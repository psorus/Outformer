...
class PriorTrainDataGenerator:  # generate synthetic data for training
    ...
    def process_one_dataset(epoch_id,
        ...
        model_entry = next((name, constructor, params) for name, constructor, params in model_choices if name == prior_name)
        ...
        #print("Model:", model_name, "Min Dim:", min_dim, "Max Dim:", max_dim, "Chosen Dim:", dim)
        ...
        if model_name == "gmm":
            ...
            del model
            return inliers, LA, sub_dims, category
            ...
            inliers, LA = params["generate_fn"](model=model)
            del model
            return inliers, LA, None, category
