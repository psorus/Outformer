...
def load_model_only_inference(path, filename, device='cpu'):
    """
    Loads a saved prior from the specified position. This function only restores inference capabilities and
    ...
    # print(f"Using a Transformer with {sum(p.numel() for p in prior.parameters()) / 1000 / 1000:.{2}f} M parameters")
